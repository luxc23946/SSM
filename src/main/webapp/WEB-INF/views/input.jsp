...
<!--  
 ...
 <form:form action="${pageContext.request.contextPath }/employee/emp" method="PUT" modelAttribute="emp">
   ...
   <fmt:message key="Department"/>:<form:select path="dept.id" items="${ depts }" itemLabel="deptName" itemValue="id"/><br/>
